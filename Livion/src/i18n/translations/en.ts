...
export const en = {
  ...
  symptoms: {
    ...
    officeHoursSchedule: 'Monday - Friday: 8:00 AM - 5:00 PM\nSaturday: 9:00 AM - 1:00 PM\nSunday: Closed',
    emergencyContact: 'Emergency Contact',
    emergencyText: 'For after-hours emergencies, please call the main office number. For life-threatening emergencies, call 112.',
    quickTip: 'Quick Tip',
